...
[Download the latest release (version 0.1.0)](https://github.com/peter88213/yw-table/raw/main/dist/yw-table_v0.1.0.zip)

- Unzip the downloaded zipfile "yw-table_v0.1.0.zip" into a new folder.
