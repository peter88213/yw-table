...
[Download the latest release (version 1.0.4)](https://github.com/peter88213/yw-table/raw/main/dist/yw_table_v1.0.4.zip)

- Unzip the downloaded zipfile "yw_table_v1.0.4.zip" into a new folder.
